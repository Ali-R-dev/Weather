            ...
            return (
              ...
              >
                  ...
                  {weatherInfo.icon === "sun" ? (
                    ...
                    >
                      <path
                        ...
                        clipRule="evenodd"
                      />
                      <path d="M3.75 14.25a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v3.75a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-3.75zm4.5 0a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v3.75a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-3.75z" />
                    </svg>
                ...
                {next24Hours.precipitation_probability[index] > 0 && (
                  <div
                    className={`text-xs rounded-full px-1.5 py-0.5 mt-1 ${
