...
const WeatherIcon: React.FC<WeatherIconProps> = ({
  ...
  const getIconColorClass = (type: string): string => {
    ...
    if (type.includes('cloud') && !type.includes('night') && !type.includes('sun'))
      return styles.cloudy;
    if (type === 'cloud-sun' || type === 'partly-cloudy' || type === 'partly-cloudy-day')
  ...
  const renderIcon = (iconType: string) => {
    ...
    switch (iconType) {
      ...
      case 'clear-night':
        return (
          <MoonIcon
            className={clsx(baseClass, styles.clearNight, styles.moonNight)}
            type={iconType}
      ...
      case 'cloud-sun': {
        ...
        return (
          <span
            ...
            aria-label={ariaLabel}
            style={{
              width: compositeSize.container,
              height: compositeSize.container,
          ...
          >
            ...
            {[0, 1, 2].map((i) => (
              <motion.span
                ...
                animate={{
                  y: [0, 14, 0],
                  opacity: [0.7 - i * 0.15, 1, 0.7 - i * 0.15],
                  x: [0, i === 1 ? 2 : -2, 0],
                }}
                transition={{
                  duration: 1.8 + i * 0.3,
