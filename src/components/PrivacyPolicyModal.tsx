        ...
        >
          <div className="p-6">
            ...
            <div className="space-y-4 text-white/80">
              <section>
                <h3 className="text-lg font-semibold text-white mb-2">Data We Store Locally</h3>
                <p className="mb-2">
                  We store the following information in your browser's local storage:
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Weather preferences (temperature unit, wind speed unit, time format)</li>
              ...
              <section>
                ...
                <p>
                  We request access to your location to provide local weather information. This is:
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Entirely optional - you can manually search for locations</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>Open-Meteo API for weather data (no API key required, privacy-focused)</li>
              ...
              <section>
                ...
                <p>
                  All data is stored locally in your browser and you can clear it at any time by:
                </p>
                <ul className="list-disc pl-5 space-y-1">
              ...
              <section>
                ...
                <p>
                  We do not use any analytics or tracking services. Your usage of the app is
                  completely private.
                </p>
              </section>

              <section>
                <h3 className="text-lg font-semibold text-white mb-2">Updates to Privacy Policy</h3>
                <p>
                  We may update this privacy policy as we add new features. Significant changes will
              ...
              <section>
                ...
                <p className="mb-2">For any questions, concerns, or feedback about:</p>
